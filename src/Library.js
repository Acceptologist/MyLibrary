...
function updateListBook(shelf,changedBook){
      ...
      setListBook(prevState=>prevState.filter((book) => {
      ...
      <div className="list-books">
        ...
        {dataExsist && (
          <div className="list-books-content">
            ...
            />
            <Shelf shelf="Want To Read" listBook={getListBook("wantToRead")} onUpdate={updateListBook} />
            <Shelf shelf="Read" listBook={getListBook("read")} onUpdate={updateListBook} />
          </div>
        )}
